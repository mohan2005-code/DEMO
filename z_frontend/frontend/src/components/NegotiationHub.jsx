...
export default function NegotiationHub({ analysis, onGenerateLetter, isGenerating, generatedLetter, onClearLetter }) {
  ...
  return (
    <div className="dashboard-grid">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        <div className="card">
          <h3 className="card-title"><FileText size={20} className="primary" /> Adaptive Settlement Recommendations</h3>
          {loans.length === 0 ? (
                    ...
                    <div style={{ display: 'flex', gap: '1.5rem', background: 'rgba(0,0,0,0.15)', padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', fontSize: '0.85rem' }}>
                      ...
                      <div>
                        ...
                        <span style={{ color: 'var(--success)', fontWeight: 700, fontSize: '1.05rem' }}>
                          ${item.settlement_amount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                        </span>
                      </div>
                    </div>
                  )}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        <div className="card">
          <h3 className="card-title"><Sparkles size={20} className="primary" /> AI Strategy Generator</h3>
